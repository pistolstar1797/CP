public class TEST3_tonatnjtaknjawe {
    public static void test() {
        ...
        System.out.println(TEST1_tonatnjtaknjawe.NORM(llstr.compareTo(llstr)));
        ...
        System.out.println(TEST1_tonatnjtaknjawe.NORM(llstr.compareTo(llstr4)));
        System.out.println(TEST1_tonatnjtaknjawe.NORM(llstr.compareTo(llstr5)));
        System.out.println(TEST1_tonatnjtaknjawe.NORM(llstr.compareTo(llstr6)));

        System.out.println(TEST1_tonatnjtaknjawe.NORM(llstr.compareTo(llstr.toString())));
        System.out.println(TEST1_tonatnjtaknjawe.NORM(llstr.compareTo(llstr2.toString())));
        System.out.println(TEST1_tonatnjtaknjawe.NORM(llstr.compareTo(llstr3.toString())));
        ...
        System.out.println(TEST1_tonatnjtaknjawe.NORM(llstr.compareTo(llstr6.toString())));

        System.out.println(TEST1_tonatnjtaknjawe.NORM(llstr.compareToIgnoreCase(llstr.toString())));
        System.out.println(TEST1_tonatnjtaknjawe.NORM(llstr.compareToIgnoreCase(llstr2.toString())));
        System.out.println(TEST1_tonatnjtaknjawe.NORM(llstr.compareToIgnoreCase(llstr3.toString())));
        ...
        System.out.println(TEST1_tonatnjtaknjawe.NORM(llstr.compareToIgnoreCase(llstr6.toString())));
